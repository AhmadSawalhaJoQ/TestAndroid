...
public class Test extends PinView {
    ...
    private int mCurLineColor = Color.RED;
    ...
    public Test(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, com.chaos.view.R.attr.pinViewStyle);
    }
    ...
    public Test(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, com.chaos.view.R.styleable.PinView, defStyleAttr, 0);

        mViewType = a.getInt(com.chaos.view.R.styleable.PinView_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(com.chaos.view.R.styleable.PinView_itemCount, DEFAULT_COUNT);
        mPinItemSize = a.getDimensionPixelSize(com.chaos.view.R.styleable.PinView_itemSize,
                res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_size));
        mPinItemHeight = mPinItemWidth = mPinItemSize;
        if (a.hasValue(com.chaos.view.R.styleable.PinView_itemHeight)) {
            mPinItemHeight = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_itemHeight,
                    res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_size));
        }
        if (a.hasValue(com.chaos.view.R.styleable.PinView_itemWidth)) {
            mPinItemWidth = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_itemWidth,
                    res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_size));
        }
        mPinItemSpacing = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_itemSpacing,
                res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_spacing));
        mPinItemRadius = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_itemRadius,
                res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_radius));
        mLineWidth = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_borderWidth,
                res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(com.chaos.view.R.styleable.PinView_borderColor);
        if (a.hasValue(com.chaos.view.R.styleable.PinView_lineWidth)) {
            mLineWidth = a.getDimensionPixelOffset(com.chaos.view.R.styleable.PinView_lineWidth,
                    res.getDimensionPixelOffset(com.chaos.view.R.dimen.pv_pin_view_item_line_width));
        }
        if (a.hasValue(com.chaos.view.R.styleable.PinView_lineColor)) {
            mLineColor = a.getColorStateList(com.chaos.view.R.styleable.PinView_lineColor);
        }
